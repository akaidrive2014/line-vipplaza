        ...
        if(!empty($data)) {
            foreach ($data as $val) {
                ...
                <div class="product-line clearfix">
                    <a href="<?php echo $this->baseUrl();?>/product/<?php echo $value->entity_id;?>/<?php echo Vipplaza::url_title($value->name);?>" target="_blank">
                        <img src="<?php echo $value->image;?>" alt="ZILDA">
                    </a>
                    <h4><strong><font color ="#333333 "><?php echo $value->name;?></font></strong></h4>
